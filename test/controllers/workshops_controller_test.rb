...
class WorkshopsControllerTest < ActionController::TestCase
  ...
  test "should create workshop" do
    assert_difference('Workshop.count') do
      post :create, workshop: { description: @workshop.description, image_id: @workshop.image_id, name: @workshop.name }
    end
  ...
  test "should update workshop" do
    patch :update, id: @workshop, workshop: { description: @workshop.description, image_id: @workshop.image_id, name: @workshop.name }
    assert_redirected_to workshop_path(assigns(:workshop))
  end
