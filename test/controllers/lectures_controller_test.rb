...
class LecturesControllerTest < ActionController::TestCase
  ...
  test "should create lecture" do
    assert_difference('Lecture.count') do
      post :create, lecture: { description: @lecture.description, image_id: @lecture.image_id, name: @lecture.name }
    end
  ...
  test "should update lecture" do
    patch :update, id: @lecture, lecture: { description: @lecture.description, image_id: @lecture.image_id, name: @lecture.name }
    assert_redirected_to lecture_path(assigns(:lecture))
  end
