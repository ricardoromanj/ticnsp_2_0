...
class PhonesControllerTest < ActionController::TestCase
  ...
  test "should create phone" do
    assert_difference('Phone.count') do
      post :create, phone: { number: @phone.number, phone_type: @phone.phone_type, user_id: @phone.user_id }
    end
  ...
  test "should update phone" do
    patch :update, id: @phone, phone: { number: @phone.number, phone_type: @phone.phone_type, user_id: @phone.user_id }
    assert_redirected_to phone_path(assigns(:phone))
  end
